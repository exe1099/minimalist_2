...
let g:airline#themes#minimalist_2#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
...
let g:airline#themes#minimalist_2#palette.normal.airline_warning = [
        ...
        \ ]
let g:airline#themes#minimalist_2#palette.insert.airline_warning  = g:airline#themes#minimalist_2#palette.normal.airline_warning
let g:airline#themes#minimalist_2#palette.visual.airline_warning  = g:airline#themes#minimalist_2#palette.normal.airline_warning
let g:airline#themes#minimalist_2#palette.replace.airline_warning = g:airline#themes#minimalist_2#palette.normal.airline_warning
...
let g:airline#themes#minimalist_2#palette.normal.airline_error = [
        ...
        \ ]
let g:airline#themes#minimalist_2#palette.insert.airline_error    = g:airline#themes#minimalist_2#palette.normal.airline_error
let g:airline#themes#minimalist_2#palette.visual.airline_error    = g:airline#themes#minimalist_2#palette.normal.airline_error
let g:airline#themes#minimalist_2#palette.replace.airline_error   = g:airline#themes#minimalist_2#palette.normal.airline_error
...
if get(g:, 'loaded_ctrlp', 0)
    let g:airline#themes#minimalist_2#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
